...
- (UIColor*)foregroundColorForStyle {
    if(self.defaultStyle == SVProgressHUDStyleLight) {
        return UIColorFromRGB(0xD9251C, 1.0);                                        //blackColor
    } else if(self.defaultStyle == SVProgressHUDStyleDark) {
        return [UIColor yellowColor];                                       //whiteColor
    } else {
...
- (UIColor*)backgroundColorForStyle {
    if(self.defaultStyle == SVProgressHUDStyleLight) {
        return [UIColor clearColor];                                        //whiteColor
    } else if(self.defaultStyle == SVProgressHUDStyleDark) {
        return [UIColor clearColor];                                        //blackColor
    } else {
